...
| `extra-patch-types` | Regular expression matching whole conventional commit types that additionally trigger a patch release. See [release notes](../guides/release-notes.md#additional-patch-types). | `""` | `refactor\|perf\|chore\|docs` |
